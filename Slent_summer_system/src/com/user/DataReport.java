...
sb.append("班次：").append(landId.getLandId()).append("  时间：").append(landId.getLandTime().toLocaleString()).append("\r\n");
sb.append("登陆信息：").append(landId.getLandInfo()).append("\r\n");
sb.append("应有金钱").append(money_need).append("实际金钱:").append(money_true).append("差异：").append(money_true-money_need).append("\r\n");
