...
<link href="http://fonts.googleapis.com/css?family=Bitter:400,400i,700&subset=latin-ext" rel="stylesheet">-->
</head>
<%
...
<body class="bg">
	...
	<div class="nav_main">
		...
		<div class="mobile-side-menu">
			<ul>
				<li class="active"><a href="main.html"><i
				...
				<li><a href="short-codes.html"><i class="fa fa-dashcube"
						aria-hidden="true"></i>Short Codes</a></li>
				...
				<div class="w3_agile_nav_main_right">
					...
					<ul class="wthree_social_icons">
						<li><a href="javascript:void(0);"
							class="w3_agileits_facebook"><i class="fa fa-facebook"
	...
	<div class="agileinfo_logo">
		<div class="agile_container">
			<h1>
				<a href="main.html">Cookhouse<span>Restaurant</span></a>
			</h1>
		</div>
	</div>
	<!-- //logo -->
	...
	<div class="banner">
		<div class="container">
			<div class="agileits_banner_left">
				...
				<div class="w3ls_more">
					<a href="contact.html" class="btn btn-3 btn-3e icon-arrow-right">Mail
						Us</a>
				</div>
			</div>
	...
	<div class="cuisine-names">
		<div class="container">
			<div class="w3_cuisine_names_left w3l_cuisine_names_left">
				<h3>
					Egg Rolls ----- <span>$3</span>
				</h3>
				<h3>
					Fried Shrimp ----- <span>$5</span>
				</h3>
				<h3>
					Wrapped Chicken ----- <span>$7</span>
				</h3>
				<h3>
					Hot and Sour Soup ----- <span>$4</span>
				</h3>
				<h3>
			...
			<div class="w3_cuisine_names_left">
				<h3>
					Mushroom Chicken ----- <span>$4</span>
				</h3>
				<h3>
					Kung pao Beef ----- <span>$7</span>
				</h3>
				<h3>
					Garlic Shrimp ----- <span>$3</span>
				</h3>
				<h3>
					Hot Been Curd ----- <span>$8</span>
				</h3>
				<h3>
					Soft Drinks ----- <span>$5</span>
				</h3>
			</div>
			<div class="clearfix"></div>
		</div>
	...
	<div class="reservation">
		<div class="container">
			<h3 class="agileits_head">
				Book your table<i class="fa fa-cutlery" aria-hidden="true"></i>
			</h3>
			<p class="agileinfo_para">
				Please call us directly at: <span>+000 123 342</span>
			</p>
			<form action="#" method="post">
				<span class="input input--nao"> <input
					...
					class="input__label input__label--nao" for="input-1"> <span
						class="input__label-content input__label-content--nao">Your
							Name</span>
					...
					class="input__field input__field--nao" type="text" id="input-2"
					placeholder=" " required="" /> <label
					class="input__label input__label--nao" for="input-2"> <span
						class="input__label-content input__label-content--nao">Phone
							Number</span>
				</label> <svg class="graphic graphic--nao" width="300%" height="100%"
						viewBox="0 0 1200 60" preserveAspectRatio="none"> <path
						d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0" />
					</svg>
				</span> <span class="agileinfo_select"> <select id="country"
				...
				</span> <span class="agileinfo_select"> <input class="date"
					id="datepicker" type="text" value="10/11/2016"
					onfocus="this.value = '';"
					onblur="if (this.value == '') {this.value = '10/11/2016';}"
					required="">
				</span> <span class="input input--nao wthree_time"> <input
					class="input__field input__field--nao" type="text" id="input-3"
					placeholder=" " required="" /> <label
					class="input__label input__label--nao" for="input-3"> <span
						class="input__label-content input__label-content--nao">Time</span>
				</label> <svg class="graphic graphic--nao" width="300%" height="100%"
						viewBox="0 0 1200 60" preserveAspectRatio="none"> <path
						d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0" />
					</svg>
				</span> <input type="submit" value="Book Now">
			</form>
		</div>
	</div>
	<!-- //reservation -->
	...
	<div class="delicious_food">
		<div class="container">
			<h3 class="agileits_head w3_agileits_head">
				Our Delicious Food<i class="fa fa-gratipay" aria-hidden="true"></i>
			</h3>
		...
		<div class="container">
			...
			<form action="#" method="post">
				<input type="email" name="email" placeholder="Your email..."
					required=""> <input type="submit" value="Subscribe Now">
			</form>
		</div>
	</div>
	<!-- //newsletter -->
